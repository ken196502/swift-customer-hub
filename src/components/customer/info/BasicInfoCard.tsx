        ...
        <dl className="divide-y">
            ...
            <dd className="col-span-2 text-sm">
              {isPersonalCustomer ? (
                <span className={cn(
                  ...
                  customer.riskLevel === "投机型" ? "bg-red-100 text-red-800" :
                  customer.riskLevel === "进取型" ? "bg-orange-100 text-orange-800" :
                  customer.riskLevel === "均衡型" ? "bg-yellow-100 text-yellow-800" :
                  customer.riskLevel === "审慎型" ? "bg-blue-100 text-blue-800" :
                  customer.riskLevel === "稳健型" ? "bg-green-100 text-green-800" :
          ...
          {isPersonalCustomer ? (
            ...
            <>
              ...
              <div className="grid grid-cols-3 py-2 px-4">
                <dt className="col-span-1 text-sm font-medium text-muted-foreground">联系电话</dt>
                <dd className="col-span-2 text-sm">{customer.phone || "-"}</dd>
              </div>
